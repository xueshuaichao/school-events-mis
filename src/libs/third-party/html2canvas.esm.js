        ...
        var iframeLoad = iframeLoader(iframe).then(function() {
            ...
            if (typeof _this.clonedReferenceElement === "undefined") {
                return Promise.reject(
                    "Error finding the " +
                        _this.referenceElement.nodeName +
...
*/
    DocumentCloner.prototype.cloneNode = function(node) {
        ...
        if (isHTMLElementNode(node) && window) {
            ...
            var before_1 = this.resolvePseudoContent(
                node,
                clone,
                styleBefore,
            ...
            var after_1 = this.resolvePseudoContent(
                node,
                clone,
                styleAfter,
    ...
    function BoundCurves(element) {
        ...
        this.topRightPaddingBox =
            trh > 0 || trv > 0
                ? getCurvePoints(
                      bounds.left +
                          Math.min(topWidth, bounds.width + borderLeftWidth),
                      bounds.top + borderTopWidth,
