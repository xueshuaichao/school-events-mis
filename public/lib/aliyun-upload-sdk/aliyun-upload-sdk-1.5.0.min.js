                        ...
                        h =
                            ((o.Hasher = f.extend({
                                ...
                                _createHmacHelper: function(e) {
                                    return function(t, n) {
                                        return new h.HMAC.init(e, n).finalize(
                                            t
                                        );
                                    };
                                }
                    ...
                    var h = (l.MD5 = c.extend({
                        ...
                        _doFinalize: function() {
                            ...
                            (n[15 + (((o + 64) >>> 9) << 4)] =
                                ...
                                this._process();
                            for (
                                var s = this._hash, u = s.words, c = 0;
                                c < 4;
                                c++
                            ) {
                                var l = u[c];
        ...
        var o = (function() {
            ...
            u = (function() {
                var e = {},
                    ...
                    U =
                        !A &&
                        n.match(/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/),
                    k =
                        U ||
                        n.match(
                ...
                if (
                    ...
                    k &&
                        (c || e.ios || p || u) &&
                        ((t.safari = !0), e.ios || (t.version = k[1])),
                    U && (t.webview = !0),
                    c)
                ) {
                    ...
                    function e(t) {
                        o(this, e),
                            ...
                            (this.options.partSize =
                                this.options.partSize ||
                                s.UPLOADDEFAULT.PARTSIZE),
                            (this.options.parallel =
                                this.options.parallel ||
                                s.UPLOADDEFAULT.PARALLEL),
                            (this.options.region =
                                this.options.region || "cn-shanghai"),
                        ...
                        i(e, [
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    for (
                                        ...
                                        t.uploadList[r].state ==
                                            a.UPLOADSTATE.SUCCESS && n++,
                                            this._uploadList[r].state == e &&
                                                (t.uploadList.splice(r, 1),
                                                r--);
                                    t.onClear &&
                                        t.onClear(t.uploadList.length, n);
                                }
                            },
                            {
                                key: "stopUpload",
                            ...
                            },
                            {
                                ...
                                value: function(e, t, n, r) {
                                    this.options;
                                    if (!(e && t && n && r)) return !1;
                                    if (this._state != a.VODSTATE.EXPIRE)
                                        return !1;
                                    if (-1 == this._curIndex) return !1;
                                    var o = "";
                                    return (
                                        this._uploadList.length >
                                            this._curIndex &&
                                            (o = this._uploadList[
                                                this._curIndex
                                            ]),
                            ...
                            },
                            {
                                ...
                                value: function(e, t, n, r) {
                                    ...
                                    o.ImageType && (i.imageType = o.ImageType),
                                        ...
                                        o.TransCodeMode &&
                                            (i.transCodeMode = o.TransCodeMode),
                            ...
                            },
                            {
                                ...
                                value: function(e, t) {
                                    ...
                                    n &&
                                        ((this._onbeforeunload = !0) &&
                                            (t = a.UPLOADSTATE.STOPED),
                                        this._saveCheckoutpoint(
                                            e,
                                            n.checkpoint,
                                            t
                                    ...
                                    window &&
                                        (window.onbeforeunload = function(t) {
                                            if (
                                                ((e._onbeforeunload = !0),
                                                -1 != e._curIndex &&
                                                    e._uploadList.length >
                                                        e._curIndex)
                                            ) {
                                                var n =
                                                    e._uploadList[e._curIndex];
                                                e._changeState(
                                                    n,
                                                    a.UPLOADSTATE.STOPED
                                                );
                            ...
                            },
                            {
                                key: "_adjustPartSize",
                                value: function(e) {
                                    return e.file.size / this.options.partSize >
                                        1e4
                                        ? e.file.size / 9999
                                        : this.options.partSize;
                                }
        ...
        (function(e) {
            ...
            (i.prototype.slice = function(e, t) {
                ...
                (i.prototype.readUInt16LE = function(e, t) {
                    return (
                        t || R(e, 2, this.length), this[e] | (this[e + 1] << 8)
                    );
                }),
                (i.prototype.readUInt16BE = function(e, t) {
                    return (
                        t || R(e, 2, this.length), (this[e] << 8) | this[e + 1]
                    );
                }),
                ...
                (i.prototype.readFloatLE = function(e, t) {
                    return (
                        t || R(e, 4, this.length), Z.read(this, e, !0, 23, 4)
                    );
                }),
                (i.prototype.readFloatBE = function(e, t) {
                    return (
                        t || R(e, 4, this.length), Z.read(this, e, !1, 23, 4)
                    );
                }),
                (i.prototype.readDoubleLE = function(e, t) {
                    return (
                        t || R(e, 8, this.length), Z.read(this, e, !0, 52, 8)
                    );
                }),
                (i.prototype.readDoubleBE = function(e, t) {
                    return (
                        t || R(e, 8, this.length), Z.read(this, e, !1, 52, 8)
                    );
                }),
                    ...
                    t = Math.abs(t),
                        isNaN(t) || t === 1 / 0
                            ...
                            : ((a = Math.floor(Math.log(t) / Math.LN2)),
                              ...
                              (t +=
                                  a + f >= 1 ? h / u : h * Math.pow(2, 1 - f)),
                              t * u >= 2 && (a++, (u /= 2)),
                              a + f >= l
                                  ? ((s = 0), (a = l))
                                  : a + f >= 1
                                  ? ((s = (t * u - 1) * Math.pow(2, o)),
                                    (a += f))
                                  : ((s =
                                        t *
                                        Math.pow(2, f - 1) *
                        ...
                        },
                        {
                            ...
                            value: function(e, t, n) {
                                ...
                                e.fileSize && (o.FileSize = e.fileSize),
                                    ...
                                    e.templateGroupId &&
                                        (o.TemplateGroupId = e.templateGroupId),
                                    e.storageLocation &&
                                        (o.StorageLocation = e.storageLocation),
                                    e.coverUrl && (o.CoverURL = e.coverUrl),
                                    e.transCodeMode &&
                                        (o.TransCodeMode = e.transCodeMode),
                                    e.userData &&
                                        (o.UserData = JSON.stringify(
                                            e.userData
                                        ));
                                var i =
                                        c.default.makeUTF8sort(o, "=", "&") +
                            ...
                            value: function(t, n, r) {
                                ...
                                var u = e.getAuthInfo(t.userId, a, i),
                                    ...
                                    h = {
                                        ...
                                        FileHash: t.fileHash,
                                        UploadId:
                                            t.checkpoint.checkpoint.uploadId,
                                        PartSize:
                                            t.checkpoint.checkpoint.partSize,
                                        DonePartsCount:
                                            t.checkpoint.checkpoint.doneParts
                                                .length,
                                        UploadPoint: JSON.stringify(
                                            t.checkpoint
                                        ),
                                        ...
                                        (e = e ? JSON.parse(e) : {}),
                                            e.UploadProgress &&
                                                e.UploadProgress
                                                    .UploadProgressList &&
                                                e.UploadProgress
                                                    .UploadProgressList.length >
                                                    0 &&
                                                ((t =
                                                    e.UploadProgress
                                                        .UploadProgressList[0]),
                                                (r = t.ClientId)),
