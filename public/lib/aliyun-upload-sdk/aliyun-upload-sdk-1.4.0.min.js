...
!(function(e) {
                    ...
                    var r =
                        ...
                        l = (i.BufferedBlockAlgorithm = o.extend({
                            ...
                            _process: function(t) {
                                ...
                                u = t
                                    ? e.ceil(u)
                                    : e.max((0 | u) - this._minBufferSize, 0);
                                var c = u * o,
                                    f = e.min(4 * c, i);
                                if (c) {
                                    for (var l = 0; l < c; l += o)
                        ...
                        h =
                            ((i.Hasher = l.extend({
                                ...
                                update: function(e) {
                                    return (
                                        this._append(e), this._process(), this
                                    );
                                },
                                finalize: function(e) {
                                    return (
                                        e && this._append(e), this._doFinalize()
                                    );
                                },
                                blockSize: 16,
                                ...
                                _createHmacHelper: function(e) {
                                    return function(t, r) {
                                        return new h.HMAC.init(e, r).finalize(
                                            t
                                        );
                                    };
                                }
    ...
    function(e, t, r) {
        ...
        var n,
            i,
            o = ("function" == typeof Symbol && Symbol.iterator, r(6)),
            a = (function(e) {
                ...
                return (
                    o(e, [
                                ...
                                return (
                                    ...
                                    !((r && !n) || (!r && n)) &&
                                        (!((e && !t) || (!e && t)) &&
                                            ...
                                            (this._ossCreditor.securityToken = r),
                                            (this._ossCreditor.expireTime = n),
                                            !0))
                                );
                            }
                        },
                        {
                            ...
                            value: function(e, t, r, n, i) {
                                ...
                                for (
                                    ...
                                    o < this._uploadList.length;
                                    o++
                                )
                                    if (this._uploadList[o].file == e)
                                        return !1;
                                var s = new Object();
                                return (
                                    (s.file = e),
                                    ...
                                    (s.isImage = v.default.isImage(e.name)),
                                    i &&
                                        ((s.videoInfo = i
                                            ? JSON.parse(i).Vod
                                            : {}),
                                        (s.userData = l.default.encode(i))),
                                    (s.ri = m.default.create()),
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                this.options;
                                if (e < 0 || e >= this._uploadList.length)
                                    return !1;
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                for (
                                    var t = this.options, r = 0, n = 0;
                                    n < this._uploadList.length;
                                    n++
                                )
                                    t.uploadList[n].state ==
                                        a.UPLOADSTATE.SUCCESS && r++,
                                        this._uploadList[n].state == e &&
                                            (t.uploadList.splice(n, 1), n--);
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                var t = this;
                                if (!e) return !1;
                                var r = JSON.parse(l.default.decode(e));
                                return (
                                    !!(
                                        r.AccessKeyId &&
                                        r.AccessKeySecret &&
                            ...
                            value: function(e, t, r, n) {
                                ...
                                return (
                                    this._uploadList.length > this._curIndex &&
                                        (i = this._uploadList[this._curIndex]),
                                    i &&
                                        (this.init(e, t, r, n),
                                        (this._state = a.VODSTATE.START),
                                        (this._ossUpload = null),
                                        this._uploadCore(i, i.retry),
                                        (i.retry = !1)),
                                    !0
                                );
                            }
                        },
                        {
                            ...
                            value: function(e, t, r) {
                                ...
                                if (this._uploadList.length > this._curIndex) {
                                    ...
                                    n.object
                                        ? this._refreshSTSTokenUpload(
                                              n,
                                              e,
                                              t,
                                              r
                                          )
                                        : this.setSTSToken(n, e, t, r);
                                }
                            }
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function(e, t, r, n) {
                                ...
                                i.ImageType && (o.imageType = i.ImageType),
                                    ...
                                    i.TemplateGroupId &&
                                        (o.templateGroupId = i.TemplateGroupId),
                                    i.StorageLocation &&
                                        (o.storageLocation = i.StorageLocation),
                                    i.CoverURL && (o.coverUrl = i.CoverURL),
                                    i.TransCodeMode &&
                                        (o.transCodeMode = i.TransCodeMode),
                        ...
                        },
                        {
                            ...
                            value: function(e, t, r, n) {
                                if (!e || !t || !r) return !1;
                                var i = JSON.parse(l.default.decode(t));
                                if (
                                    !(
                                        i.AccessKeyId &&
                                        i.AccessKeySecret &&
                                ...
                                if (r) {
                                    if (
                                        ((o = JSON.parse(l.default.decode(r))),
                                        !o.Endpoint || !o.Bucket || !o.FileName)
                                    )
                                        return (
                                            console.error(
                                                "uploadAddress is invalid"
                                            ),
                                            !1
                                        );
                                } else
                                    (o.Endpoint = a.endpoint),
                                        (o.Bucket = a.bucket),
                                        (o.FileName = a.object);
                                (this._ut = "vod"), (this._uploadWay = "vod");
                                var a = e;
                                this.init(
                                    i.AccessKeyId,
                                    i.AccessKeySecret,
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                var t =
                                        ...
                                        arguments[1],
                                    r = this.options;
                                if (((e.retry = t), r.onUploadstarted && !t))
                                    try {
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                ...
                                if (
                                    ((e.state = a.UPLOADSTATE.UPLOADING),
                                    !this._ossUpload)
                                ) {
                                    e.endpoint =
                                        e.endpoint ||
                                    ...
                                    this._ossUpload = new c.default(
                                        {
                                            bucket: e.bucket,
                                            endpoint: e.endpoint,
                                            AccessKeyId: this._ossCreditor
                                                .accessKeyId,
                                            AccessKeySecret: this._ossCreditor
                                                .accessKeySecret,
                                            SecurityToken: this._ossCreditor
                                                .securityToken,
                                ...
                                var r = v.default.getFileType(e.file.name),
                        ...
                        },
                        {
                            ...
                            value: function() {
                                for (
                                    var e = -1, t = 0;
                                    t < this._uploadList.length;
                                    t++
                                )
                                    if (
                                        this._uploadList[t].state ==
                                        a.UPLOADSTATE.INIT
                                    ) {
                                        e = t;
                                        break;
                                ...
                                if ("cancel" == t.name)
                                    ...
                                    if (
                                        ...
                                        if (this.options.onUploadTokenExpired) {
                                            (this._state = a.VODSTATE.EXPIRE),
                                                (e.state =
                                                    a.UPLOADSTATE.FAIlURE);
                                            try {
                                                this.options.onUploadTokenExpired(
                                                    e,
                                                    t
                                                );
                                            } catch (e) {
                        ...
                        },
                        {
                            ...
                            value: function(e, t) {
                                ...
                                t &&
                                    t.res &&
                                    t.res.headers &&
                                    (r = t.res.headers["x-oss-request-id"]),
                                    this._removeCheckoutpoint(e);
                                var n = this;
                                setTimeout(function() {
                                    n.nextUpload();
                        ...
                        },
                        {
                            ...
                            value: function(e, t, r) {
                                ...
                                r &&
                                    r.headers &&
                                    (s = r.headers["x-oss-request-id"]),
                                    0 != t.loaded &&
                                        this._reportLog("20007", e, {
                                            pn: o,
                                            requestId: s
                                        }),
                                    1 != t.loaded &&
                        ...
                        },
                        {
                            ...
                            value: function(e, t, r) {
                                if (t) {
                                    ...
                                    d.default.set(n, JSON.stringify(o));
                                }
                            }
                        },
                        {
                            ...
                            value: function(e, t) {
                                ...
                                r &&
                                    this._saveCheckoutpoint(e, r.checkpoint, t);
                            }
                        },
                        {
                            ...
                            value: function() {
                                ...
                                window &&
                                    (window.onbeforeunload = function(t) {
                                        if (
                                            -1 != e._curIndex &&
                                            e._uploadList.length > e._curIndex
                                        ) {
                        ...
                        o(e, [
                            {
                                ...
                                value: function(e) {
                                    ...
                                    var t = {
                                        ...
                                        endpoint:
                                            e.endpoint || this._config.endpoint,
                            ...
                            },
                            {
                                ...
                                value: function(e, t) {
                                    ...
                                    t.headers && (i.headers = t.headers),
                                        e.checkpoint &&
                                            (i.checkpoint = e.checkpoint),
                                        e.bucket ||
                                            (this.oss.options.bucket =
                                                e.bucket),
                                        e.endpoint ||
                                            (this.oss.options.endpoint =
                                                e.endpoint),
                                        this.oss
                                            .multipartUpload(
                                                e.object,
                                            ...
                                            .catch(function(e) {
                                                r.oss.cancel &&
                                                    (r.oss && r.oss.isCancel()
                                                        ? console.log(
                                                              "oss is cancel as error"
                                                          )
                                                        : r.oss.cancel()),
                                                    r._error(e);
                                            });
        ...
        (function(e) {
            ...
            function m(e, t, r, n, i) {
                ...
                if (("string" == typeof t && (t = o.from(t, n)), o.isBuffer(t)))
                    return 0 === t.length ? -1 : T(e, t, r, n, i);
                if ("number" == typeof t)
                    return (
                        (t &= 255),
                        o.TYPED_ARRAY_SUPPORT &&
            ...
            (o.prototype.slice = function(e, t) {
                ...
                if (o.TYPED_ARRAY_SUPPORT)
                    (n = this.subarray(e, t)), (n.__proto__ = o.prototype);
                else {
                    var i = t - e;
                    n = new o(i, void 0);
                ...
                (o.prototype.readUInt16LE = function(e, t) {
                    return (
                        t || x(e, 2, this.length), this[e] | (this[e + 1] << 8)
                    );
                }),
                (o.prototype.readUInt16BE = function(e, t) {
                    return (
                        t || x(e, 2, this.length), (this[e] << 8) | this[e + 1]
                    );
                }),
                ...
                (o.prototype.readFloatLE = function(e, t) {
                    return (
                        t || x(e, 4, this.length), Z.read(this, e, !0, 23, 4)
                    );
                }),
                (o.prototype.readFloatBE = function(e, t) {
                    return (
                        t || x(e, 4, this.length), Z.read(this, e, !1, 23, 4)
                    );
                }),
                (o.prototype.readDoubleLE = function(e, t) {
                    return (
                        t || x(e, 8, this.length), Z.read(this, e, !0, 52, 8)
                    );
                }),
                (o.prototype.readDoubleBE = function(e, t) {
                    return (
                        t || x(e, 8, this.length), Z.read(this, e, !1, 52, 8)
                    );
                }),
    ...
    function(e, t, r) {
        ...
        function o(e) {
            var t,
                ...
                a,
                s = e.length;
            (o = n(e)), (a = new l((3 * s) / 4 - o)), (r = o > 0 ? s - 4 : s);
            var u = 0;
            for (t = 0; t < r; t += 4)
                (i =
                    (f[e.charCodeAt(t)] << 18) |
    ...
    function(e, t, r) {
        ...
        var o = (function() {
            ...
            p = (function() {
                function e(t) {
                    i(this, e);
                    var r = d.default.os.name,
                        n = d.default.os.version || "",
                        o = d.default.browser.name,
                    ...
                    d.default.os.ipad
                        ? (f = "pad")
                        : (d.default.os.iphone || d.default.os.android) &&
                          (f = "phone"),
                        (this._ri = s.default.create()),
                        (this.initParam = {
                            APIVersion: "0.6.0",
                            lv: "1",
                            av: l.default.version,
                            pd: "upload",
                            sm: "upload",
                            md: "uploader",
                            uuid: e.getUuid(),
                        ...
                        [
                            {
                                ...
                                value: function(e, t) {
                                    ...
                                    var i = r.join("&");
                                    this.initParam.args = encodeURIComponent(
                                        "" == i ? "0" : i
                                    );
                                    var o = [];
                                    for (var n in this.initParam)
                                        o.push(n + "=" + this.initParam[n]);
                                    var a = o.join("&");
                                    if (
                                        AliyunUpload &&
                                        AliyunUpload.__logTestCallback__
                                    )
                    ...
                    i(e, null, [
                        {
                            ...
                            value: function(e) {
                                for (
                                    ...
                                    if (0 == i.indexOf(t))
                                        return unescape(
                                            i.substring(t.length + 1, i.length)
                                        );
                                }
                                return "";
                            }
        ...
        var i = (function() {
            ...
            a = function() {
                ...
                return (
                    ...
                    (e.indexOf("Windows NT 6.3") > -1 ||
                        e.indexOf("Windows 8.1") > -1) &&
                        (t = "8.1"),
                    (e.indexOf("Windows NT 10") > -1 ||
                        e.indexOf("Windows 10") > -1) &&
                        (t = "10"),
                    t
                );
            },
            ...
            u = (function() {
                var e = {},
                    ...
                    I =
                        r.match(/MSIE\s([\d.]+)/) ||
                        r.match(/Trident\/[\d](?=[^\?]+).*rv:([0-9.].)/),
                    k =
                        !S &&
                        r.match(/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/),
                    U =
                        k ||
                        r.match(
                ...
                if (
                    ((t.webkit = !!i) && (t.version = i[1]),
                    u && ((e.android = !0), (e.version = u[2])),
                    h &&
                        !l &&
                        ((e.ios = e.iphone = !0),
                        (e.version = h[2].replace(/_/g, "."))),
                    f &&
                        ((e.ios = e.ipad = !0),
                        (e.version = f[2].replace(/_/g, "."))),
                    l &&
                        ((e.ios = e.ipod = !0),
                        (e.version = l[3] ? l[3].replace(/_/g, ".") : null)),
                    g && ((e.wp = !0), (e.version = g[1])),
                    d && ((e.webos = !0), (e.version = d[2])),
                    y && (e.touchpad = !0),
                    m && ((e.blackberry = !0), (e.version = m[2])),
                    T && ((e.bb10 = !0), (e.version = T[2])),
                    w && ((e.rimtabletos = !0), (e.version = w[2])),
                    A && (t.playbook = !0),
                    v && ((e.kindle = !0), (e.version = v[1])),
                    _ && ((t.silk = !0), (t.version = _[1])),
                    !_ && e.android && r.match(/Kindle Fire/) && (t.silk = !0),
                    S && ((t.chrome = !0), (t.version = S[1])),
                    b && ((t.firefox = !0), (t.version = b[1])),
                    E && ((e.firefoxos = !0), (e.version = E[1])),
                    ...
                    i(e, null, [
                        ...
                        },
                        {
                            ...
                            get: function() {
                                var e = u.browser;
                                return (
                                    e.name || (e.name = this.getBrowserType()),
                                    e
                                );
                            }
                        }
                    ...
                    o(e, null, [
                        {
                            ...
                            value: function(e, t, r) {
                                var n =
                                    ...
                                    o =
                                        c.default.makeUTF8sort(i, "=", "&") +
                                        "&Signature=" +
                                        c.default.aliyunEncodeURI(
                                            c.default.makeChangeSiga(
                                                i,
                                                e.accessKeySecret
                                            )
                                        ),
                        ...
                        },
                        {
                            ...
                            value: function(e, t, r) {
                                ...
                                e.fileSize && (i.FileSize = e.fileSize),
                                    ...
                                    e.templateGroupId &&
                                        (i.TemplateGroupId = e.templateGroupId),
                                    e.storageLocation &&
                                        (i.StorageLocation = e.storageLocation),
                                    e.coverUrl && (i.CoverURL = e.coverUrl),
                                    e.transCodeMode &&
                                        (i.TransCodeMode = e.transCodeMode),
