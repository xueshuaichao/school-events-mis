...
!(function(a) {
    ...
    var b,
            ...
            if (!document.currentScript || !(d = document.currentScript.src)) {
                ...
                if ("readyState" in f[0])
                    for (
                        a = f.length;
                        a-- &&
                        ("interactive" !== f[a].readyState || !(d = f[a].src));
        ...
        u = function(b) {
            ...
            return (
                h.length &&
                    (g += "trustedOrigins=" + encodeURIComponent(h.join(","))),
    ...
    var M = function(a) {
        c.ready === !0 &&
        c.bridge &&
        "function" == typeof c.bridge.setHandCursor
    ...
    var U = function(b, c) {
        ...
        V = {
            ...
            error: {
                ...
                "flash-outdated":
                    "Flash is too outdated to support ZeroClipboard",
                "flash-unavailable":
        ...
        W = function(a, d) {
            if (a || (d && d.type)) {
                ...
                return (
                    ...
                    f && (d.message = f),
                    "ready" === d.type &&
                        z(d, { target: null, version: c.version }),
                    "error" === d.type &&
                        ((d.target = null),
        ...
        X = function(a) {
            var b =
                a && a.getAttribute && a.getAttribute("data-clipboard-target");
        ...
        if (f && f.length) {
            for (d = 0, e = f.length; e > d; d++)
                (a = f[d].replace(/^on/, "")),
                    ...
                    i[a].push(b);
            if (
                (h.ready && c.ready && L.emit({ type: "ready", client: this }),
                h.error)
            ) {
                var j = [
                    "disabled",
