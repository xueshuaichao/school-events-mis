    ...
    return (
        ...
        b("base", ["dollar", "promise"], function(b, c) {
            ...
            return {
                ...
                guid: (function() {
                    ...
                    return function(b) {
                        for (
                            var c = (+new Date()).toString(32), d = 0;
                            5 > d;
                            d++
                        )
                    ...
                    request: function(b, d, e) {
                        ...
                        for (d = c(d) ? d : [d]; m > k; k++)
                            (f = l[k]),
                                (h = f.invoke(b, d)),
                                h !== g &&
                                    (a.isPromise(h) ? o.push(h) : n.push(h));
                        return e || o.length
                            ? ((i = a.when.apply(a, o)),
                              (j = i.pipe ? "pipe" : "then"),
                              i[j](function() {
                    ...
                    init: function(b) {
                        if (
                            ...
                            var e,
                                ...
                                h = d.extend(
                                    {},
                                    { container: b.paste, accept: b.accept }
                                );
                            return (
                                (e = new c(h)),
                                e.once("ready", g.resolve),
        ...
        b("lib/filepicker", ["base", "runtime/client", "lib/file"], function(
            ...
            function e(a) {
                ...
                (a.innerHTML =
                    a.innerHTML || a.label || a.container.html() || ""),
            ...
            return (
                ...
                b.inherits(c, {
                    ...
                    destroy: function() {
                        this.runtime &&
                            (this.exec("destroy"), this.disconnectRuntime());
                    }
                }),
                e
            );
        ...
        b("lib/image", ["base", "runtime/client", "lib/blob"], function(
            a,
            b,
            c
        ) {
                ...
                e.extend(d.prototype, {
                    ...
                    getFiles: function() {
                        for (
                            ...
                            (a = this._queue[d]),
                                (!b.length || ~e.inArray(a.getStatus(), b)) &&
                                    c.push(a);
                        return c;
                    },
                    ...
                    },
                    {
                        init: function(b) {
                            var d,
                                ...
                                m = this;
                            if (
                                (g.isPlainObject(b.accept) &&
                                    (b.accept = [b.accept]),
                                b.accept)
                            ) {
                                for (
                                    j = [], h = 0, e = b.accept.length;
                                    e > h;
                                    h++
                                )
                        ...
                        getFiles: function() {
                            return this.queue.getFiles.apply(
                                this.queue,
                                arguments
                            );
                        },
                        fetchFile: function() {
                            return this.queue.fetch.apply(
                                this.queue,
                                arguments
                            );
                        },
                        ...
                        },
                        {
                            ...
                            _finishFile: function(a, b, c) {
                                ...
                                return d
                                    ...
                                    .fail(function(b) {
                                        a.getStatus() === h.PROGRESS &&
                                            a.setStatus(h.ERROR, b),
                        ...
                        c.duplicate ||
                            (b.on("beforeFileQueued", function(b) {
                                var c =
                                    b.__hash ||
                                    (b.__hash = a(
                                        b.name + b.size + b.lastModifiedDate
                                    ));
                                return d[c]
                                    ? (this.trigger("error", "F_DUPLICATE", b),
                                      !1)
                                    : void 0;
                            }),
            ...
            function(a, b, c) {
                ...
                return b.register("DragAndDrop", {
                    init: function() {
                        ...
                        (this.dragEnterHandler = a.bindFn(
                            this._dragEnterHandler,
                            this
                        )),
                            (this.dragOverHandler = a.bindFn(
                                this._dragOverHandler,
                                this
                            )),
                            (this.dragLeaveHandler = a.bindFn(
                                this._dragLeaveHandler,
                                this
                            )),
                            (this.dropHandler = a.bindFn(
                                this._dropHandler,
                                this
                            )),
                            (this.dndOver = !1),
                    ...
                    _dragEnterHandler: function(a) {
                        ...
                        return (
                            ...
                            c.dndOver ||
                                ...
                                b &&
                                    b.length &&
                                    (c._denied = d = !c.trigger("accept", b)),
                                c.elem.addClass(e + "over"),
                                c.elem[d ? "addClass" : "removeClass"](
                                    e + "denied"
                                )),
                            ...
                            b.isFile
                                ...
                                : b.isDirectory &&
                                  b.createReader().readEntries(function(b) {
                                      ...
                                      for (f = 0; g > f; f++)
                                          h.push(
                                              e._traverseDirectoryTree(b[f], i)
                                          );
                ...
                (b = {
                    ...
                    updateImageHead: function(a, b) {
                        ...
                        return (
                            ...
                            (d = a.slice
                                ? a.slice(e)
                                : new Uint8Array(a).subarray(e)),
                            (c = new Uint8Array(
                                b.byteLength + 2 + d.byteLength
                            )),
                            (c[0] = 255),
                            (c[1] = 216),
                ...
                return (
                    ...
                    (c.exifTagTypes = {
                        ...
                        5: {
                            getValue: function(a, b, c) {
                                return (
                                    a.getUint32(b, c) / a.getUint32(b + 4, c)
                                );
                            },
                            size: 8
                        },
                    ...
                    destroy: function() {
                        ...
                        (this._img.onload = null),
                            a &&
                                (a
                                    .getContext("2d")
                                    .clearRect(0, 0, a.width, a.height),
                                (a.width = a.height = 0),
                                (this._canvas = null)),
                            (this._img.src = d),
        ...
        b(
            ...
            function(b, c, d) {
                function e() {
                    ...
                    return (
                        (a = a.match(/\d+/g)), parseFloat(a[0] + "." + a[1], 10)
                    );
                }
                function f() {
                    function d(a, b) {
